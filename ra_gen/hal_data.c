...
gpt_instance_ctrl_t g_timer_sg90_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_sg90_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_timer_sg90_extend =
        { .gtioca =
...
#if 0
    .p_pwm_cfg             = &g_timer_sg90_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
    .gtior_setting.gtior_b.gtioa  = (0U << 4U) | (1U << 2U) | (2U << 0U),
...
const timer_cfg_t g_timer_sg90_cfg =
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 8%. */.period_counts = (uint32_t) 0x4c4b40,
  .duty_cycle_counts = 0x61a80, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = NULL,
...
const timer_instance_t g_timer_sg90 =
{ .p_ctrl = &g_timer_sg90_ctrl, .p_cfg = &g_timer_sg90_cfg, .p_api = &g_timer_on_gpt };
sci_b_uart_instance_ctrl_t g_uart_esp32_ctrl;

sci_b_baud_setting_t g_uart_esp32_baud_setting =
        {
...
const sci_b_uart_extended_cfg_t g_uart_esp32_cfg_extend =
{ .clock = SCI_B_UART_CLOCK_INT, .rx_edge_start = SCI_B_UART_START_BIT_FALLING_EDGE, .noise_cancel =
  ...
  .rx_fifo_trigger = SCI_B_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &g_uart_esp32_baud_setting, .flow_control =
...
const uart_cfg_t g_uart_esp32_cfg =
{ .channel = 0, .data_bits = UART_DATA_BITS_8, .parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
          esp32_uart_callback,
  .p_context = NULL, .p_extend = &g_uart_esp32_cfg_extend,
...
/* Instance structure to use this module. */
const uart_instance_t g_uart_esp32 =
{ .p_ctrl = &g_uart_esp32_ctrl, .p_cfg = &g_uart_esp32_cfg, .p_api = &g_uart_on_sci_b };
